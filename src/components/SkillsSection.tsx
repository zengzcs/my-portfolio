...
const skills: Skill[] = [
  ...
  { name: 'Fastify / NestJS', percent: 88, color: 'magenta' },
  { name: 'Rust / Axum', percent: 82, color: 'yellow' },
  { name: 'vLLM / SGLang / llama.cpp', percent: 80, color: 'yellow' },
      ...
      <div className="container">
        ...
        <div style={{ marginTop: 30 }}>
          <div className="card card-green">
            <h3 className="card-title" style={{ color: 'var(--neon-green)', textShadow: '0 0 8px rgba(57,255,20,0.5)' }}>
              DevOps & 基础设施
            </h3>
        ...
        <div style={{ marginTop: 30 }}>
          <div className="card card-yellow" style={{ textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 8, marginTop: 16 }}>
              {['React', 'TypeScript', 'Fastify', 'NestJS', 'Rust', 'Axum', 'vLLM', 'SGLang', 'llama.cpp', 'Docker', 'AWS', 'Tailwind', 'GraphQL', 'Redis', 'MongoDB', 'Vite', 'Astro'].map((tech) => (
